...
const products = [
  {
    ...
    badge: 'Disponible',
    code: 'SS-HAT-001',
    image: studioAsset('products/caps/red-white-s-detail.jpg'),
    gallery: [studioAsset('products/caps/red-white-s-detail.jpg'), studioAsset('products/caps/red-white-s-front.jpg')],
