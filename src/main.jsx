...
const products = [
  {
    ...
    badge: 'Disponible',
    code: 'SS-HAT-001',
    image: publicAsset('products/caps/red-white-s-front.jpg'),
    gallery: [publicAsset('products/caps/red-white-s-front.jpg'), publicAsset('products/caps/red-white-s-detail.jpg')],
  ...
  },
  {
    ...
    badge: 'Disponible',
    code: 'SS-HAT-002',
    image: publicAsset('products/caps/cream-black-s.jpg'),
  ...
  },
  {
    ...
    badge: 'Nuevo modelo',
    code: 'SS-HAT-003',
    image: publicAsset('products/caps/familia-navy-front.jpg'),
    gallery: [publicAsset('products/caps/familia-navy-front.jpg'), publicAsset('products/caps/familia-navy-side.jpg')],
  ...
  },
  {
    ...
    badge: 'Nuevo modelo',
    code: 'SS-HAT-004',
    image: publicAsset('products/caps/familia-white-blue-detail.jpg'),
    gallery: [publicAsset('products/caps/familia-white-blue-detail.jpg'), publicAsset('products/caps/familia-white-blue-front.jpg')],
  ...
  },
  {
    ...
    badge: 'Disponible',
    code: 'SS-HAT-005',
    image: publicAsset('products/caps/corduroy-black-camel.jpg'),
    imagePosition: 'center 48%',
  ...
  },
  {
    ...
    badge: 'Disponible',
    code: 'SS-HAT-006',
    image: publicAsset('products/caps/tiger-white-black.jpg'),
  ...
  },
  {
    ...
    code: 'SS-HAT-007',
    image: publicAsset('products/caps/domi-front.jpg'),
    gallery: [publicAsset('products/caps/domi-front.jpg'), publicAsset('products/caps/domi-side.jpg')],
    imagePosition: 'center 44%',
  ...
  },
  {
    ...
    badge: 'Disponible',
    code: 'SS-HAT-008',
    image: publicAsset('products/caps/red-black-s.jpg'),
    imagePosition: 'center 48%',
  ...
  },
  {
    ...
    badge: 'Disponible',
    code: 'SS-HAT-009',
    image: publicAsset('products/caps/yellow-black-s.jpg'),
    imagePosition: 'center 48%',
  ...
  },
  {
    ...
    badge: 'Edición especial',
    code: 'SS-HAT-010',
    image: publicAsset('products/caps/caribe-front.jpg'),
    gallery: [publicAsset('products/caps/caribe-front.jpg'), publicAsset('products/caps/caribe-flags-back.jpg')],
  ...
  },
  {
    ...
    badge: 'Disponible',
    code: 'SS-HAT-012',
    image: publicAsset('products/caps/green-black-front.jpg'),
    gallery: [publicAsset('products/caps/green-black-front.jpg'), publicAsset('products/caps/green-black-back.jpg')],
    imagePosition: 'center 48%',
  ...
  },
  {
    ...
    badge: 'Más comentada',
    code: 'SS-HAT-013',
    image: publicAsset('products/caps/peace-front.jpg'),
    gallery: [publicAsset('products/caps/peace-front.jpg'), publicAsset('products/caps/peace-back.jpg')],
    imagePosition: 'center 49%',
  ...
  },
  {
    ...
    badge: 'Nuevo modelo',
    code: 'SS-HAT-014',
    image: publicAsset('products/caps/pinstripe-cream.jpg'),
    imagePosition: 'center 47%',
  ...
  },
  {
    ...
    badge: 'Edición especial',
    code: 'SS-HAT-015',
    image: publicAsset('products/caps/respect-front.jpg'),
    gallery: [publicAsset('products/caps/respect-front.jpg'), publicAsset('products/caps/respect-side.jpg'), publicAsset('products/caps/respect-back.jpg')],
