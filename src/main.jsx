...
const products = [
  {
    ...
    badge: 'Más vendida',
    code: 'SS-HAT-001',
    image: publicAsset('products/black-cap.jpg'),
    imagePosition: 'center',
    description: 'La clásica de la familia Súper Suero. Logo S bordado, ajuste cómodo y una pieza que combina con todo.',
    details: ['Algodón resistente', 'Logo S bordado', 'Cierre ajustable', '100% original'],
  },
  {
    id: 'ss-cap-caribe',
    name: 'Gorra Peace',
    subtitle: 'Multicolor / Peace',
    category: 'Gorras',
    price: 1300,
    stock: 18,
    sold: 31,
    ...
    badge: 'Nuevo modelo',
    code: 'SS-HAT-002',
    image: publicAsset('products/peace.jpg'),
    imagePosition: 'center',
    description: 'Uno de los modelos multicolores de Súper Suero. Peace por un lado y el mensaje de amor por el otro.',
    details: ['Paneles multicolor', 'Logo S bordado', 'Visera curva', 'RD$1,300'],
  },
  {
    id: 'ss-cap-story-time',
    name: 'Gorra Story Time',
    subtitle: 'Multicolor / banderas',
    category: 'Gorras',
    price: 1450,
    stock: 12,
    sold: 23,
    ...
    badge: 'Story Time',
    code: 'SS-HAT-003',
    image: publicAsset('products/new-drop-03.jpg'),
    imagePosition: 'center',
    description: 'Cada bandera es una historia. Cada color es una historia. Cada palabra es una historia.',
    details: ['Colección Story Time', 'Paneles multicolor', 'Logo S bordado', 'RD$1,450'],
  },
  {
    id: 'ss-cap-verano',
    name: 'Gorra Colección Verano',
    subtitle: '5 colores / vintage',
    category: 'Gorras',
    price: 1650,
    stock: 16,
    sold: 18,
    ...
    code: 'SS-HAT-004',
    image: publicAsset('products/five-colors.jpg'),
    imagePosition: 'center 43%',
    description: 'Una colección vintage y fresh para hombres, mujeres, niños y niñas. Disponible en varios colores.',
    details: ['Rojo / negro / blanco', 'Negro / dorado', 'Amarillo / negro / blanco', 'Verde / negro / blanco'],
  },
  {
    id: 'ss-cap-domi',
    name: 'Gorra DOMI',
    subtitle: 'Edición dominicana',
    category: 'Gorras',
    price: 1750,
    stock: 8,
    sold: 16,
    ...
    code: 'SS-HAT-005',
    image: publicAsset('products/domi.jpg'),
    imagePosition: 'center 32%',
    description: 'Una edición especial para los dominicanos, para la familia y para todo el que lleva la bandera con orgullo.',
    details: ['Edición DOMI', 'Bandera dominicana', 'Logo bordado', 'DM para pedidos'],
  },
  {
...
function ProductArt({ product, small = false, hero = false }) {
  ...
  if (product.image) {
    return (
      <div className={`${artClass} product-art--photo`} aria-hidden="true">
        <img src={product.image} alt="" style={{ objectPosition: product.imagePosition || 'center' }} />
